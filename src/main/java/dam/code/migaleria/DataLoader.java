    ...
    public void run(String... args) {
        ...
        List<Pelicula> peliculas = List.of(
                new Pelicula("Cómo entrenar a tu dragón",
                        ...
                        "https://streamimdb.ru/embed/movie/tt26743210"),
                ...
                new Pelicula("Ratatouille",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0382932"),
                ...
                new Pelicula("Los Increíbles",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0317705"),
                ...
                new Pelicula("Toy Story",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0114709"),
                ...
                new Pelicula("Shrek",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0126029"),
                ...
                new Pelicula("Del revés (Inside Out)",
                        ...
                        "https://streamimdb.ru/embed/movie/tt2096673"),
                ...
                new Pelicula("Kung Fu Panda",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0441773"),
                ...
                new Pelicula("Big Hero 6",
                        ...
                        "https://streamimdb.ru/embed/movie/tt2245084"),
                ...
                new Pelicula("Gru, mi villano favorito",
                        ...
                        "https://streamimdb.ru/embed/movie/tt1323594"),
                ...
                new Pelicula("Up",
                        ...
                        "https://streamimdb.ru/embed/movie/tt1049413"),
                ...
                new Pelicula("Buscando a Nemo",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0266543"),
                ...
                new Pelicula("Frozen",
                        ...
                        "https://streamimdb.ru/embed/movie/tt2294629"),
                ...
                new Pelicula("Brave (Indomable)",
                        ...
                        "https://streamimdb.ru/embed/movie/tt1217209"),
                ...
                new Pelicula("La bella y la bestia",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0101414"),
                ...
                new Pelicula("Pesadilla antes de Navidad",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0107688"),
                ...
                new Pelicula("Coraline",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0327597"),
                ...
                new Pelicula("Monstruos, S.A.",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0198781"),
                ...
                new Pelicula("Wall-E",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0910970"),
                ...
                new Pelicula("Spider-Man: Un nuevo universo",
                        ...
                        "https://streamimdb.ru/embed/movie/tt4633694"),
                ...
                new Pelicula("El gigante de hierro",
                        ...
                        "https://streamimdb.ru/embed/movie/tt0129167"),
                ...
                new Pelicula("El libro de la selva",
                        ...
                        "https://streamimdb.ru/embed/movie/tt3040964")
        );

        peliculaRepository.saveAll(peliculas);
        System.out.println("[DataLoader] " + peliculas.size() + " películas cargadas con enlaces públicos.");
    }
}
